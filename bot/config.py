...
class Config(object):
    ...
    TG_BOT_TOKEN = get_config("7832011152:AAEae4rRmHGCKlyoiZh-E6gSi2IOrlYNEaM", "")
    # The Telegram API things
    APP_ID = int(get_config("24853719", 12345))
    API_HASH = get_config("d88df23f822a7e3bf60157a0f3a8a11d", "")
